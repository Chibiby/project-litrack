// Ad-hoc check for the DATABASE_URL normalization in src/lib/prisma.ts.
...
const cases = [
  ...
  ["6543 already correct", `postgresql://postgres.ref:${PW}@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=1`],
...
for (const [label, input] of cases) {
  ...
  const okFlag = !is6543 || (out.includes("pgbouncer=true") && out.includes("connection_limit=1"));
