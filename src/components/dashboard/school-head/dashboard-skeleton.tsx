...
/**
 * Mirrors `TeacherDashboardSkeleton` block for block
 * (`docs/school-head-ui-rework.md` section 3.7): hero, six stat cards, three
 * donut panels beside a calendar and attention rail, quick actions, then the
 * two-chart row. Three panel skeletons, not two — the school-wide weekly
 * attendance donut (section 0a decision 4) is a third panel beside the two
 * coverage donuts in `overview-panels.tsx`, and this skeleton must match that
 * geometry or the page reflows when the data lands.
 */
...
export function SchoolHeadDashboardSkeleton() {
  return (
